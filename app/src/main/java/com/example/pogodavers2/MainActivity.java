package com.example.pogodavers2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void api_key(final String City) {
        ...
        Request request = new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/weather?q=" + search.getText().toString() + "&appid=3a0af78e48c6ead1692f71a067fea318&units=metric")
                .get()
                .build();
